...
| 문서 | 접두사 | 범위 | 원본 기능 |
| --- | --- | --- | --- |
| [01 에이전트 실행과 모델 호출](01-agent-execution.md) | `AGT` | 에이전트 수명주기, 실행 진입점, 모델 호출, 스트리밍 | 01, 03 |
| [02 메시지와 콘텐츠 모델](02-message-content.md) | `MSG` | 역할, 콘텐츠 종류, 응답, 사용량, 종료 사유 | 02 |
| [03 구조화 출력](03-structured-output.md) | `OUT` | 스키마 요청, 네이티브·폴백 경로, 파싱 실패 | 04 |
| [04 도구 정의와 실행 루프](04-tools.md) | `TOOL` | 도구 스키마, 호출 루프, 예산, 승인 | 05, 06 |
| [05 MCP 연동](05-mcp.md) | `MCP` | MCP 클라이언트 도구, 서버 호스팅 | 07, 24 |
| [06 세션과 대화 상태](06-sessions.md) | `SES` | 세션 식별, 직렬화, 저장소, 이력, 컨텍스트 | 08, 09 |
| [07 인터셉터와 컨텍스트 관리](07-interceptors.md) | `INT` | 실행 인터셉터, 컴팩션 | 10, 11 |
| [08 하네스 기능](08-harness.md) | `HAR` | 하네스 조립, 제공자, 스킬, 코드 실행 | 12, 13 |
| [09 워크플로와 오케스트레이션](09-workflows.md) | `WF` | 그래프, 런타임, 체크포인트, 조합, 선언형 | 14, 15, 16, 17, 18, 19 |
| [10 호스팅과 프로토콜](10-hosting.md) | `HOST` | 호스팅 코어, Responses, A2A, AG-UI, 식별 | 20, 21, 22, 23, 25, 26 |
| [11 운영 품질](11-operations.md) | `OPS` | 관찰성, 오류, 보안, 평가, 패키징 | 27, 28, 29, 30 |
| [12 공급자 통합](12-providers.md) | `PRV` | 모델 공급자, 인프라 어댑터 | 31 |

31개 기능이 모두 매핑된다. 문서 수와 기능 수는 일치할 필요가 없다. 하나의 요구사항
문서가 여러 기능을 다룰 수 있고, 하나의 기능이 여러 요구사항을 만들 수 있다.
