 ...
 * io.github.hellices.agentframework.mcp.McpStdioTools} owns the connection instead: it builds the
 * transport, drives the handshake, replaces a connection it has lost at most once, and closes what
 * it created. Even then nothing happens implicitly, because opening the connection is always an
 * explicit call. Prompts, resources, sampling, and MCP tasks are deliberately absent and are
 * separate requirement slices.
 *
