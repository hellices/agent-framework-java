...
public final class OpenAiChatModelClient implements ModelClient {
   ...
   * Runs one model call.
   *
   * <p>The returned stage carries no completion authority: completing or cancelling the future
   * taken from it settles that future alone, leaving the provider call and this run untouched.
   *
